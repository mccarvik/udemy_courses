...
# We can then use the difference in price between the two stocks as signal if 
# one moves out of correlation with the other. It is an older strategy that is
# used classically as a guide to beginning algorithmic trading. There is a 
# fantastic full guide and write up on Investopedia you can find
# [here](http://www.investopedia.com/university/guide-pairs-trading/)! 
# **I highly recommend reading the article in full before continuing, it is
# entertaining and informative!**
# 
# 
# Let's create our first basic trading algorithm! This is an exercise in 
# using quantopian, **NOT** a realistic representation of what a good
# algorithm is! Never use something as simple as this in the real world! 
# This is an extremely simplified version of Pairs Trading, we won't be 
# considering factors such as cointegration!
import sys
import numpy as np
import pandas as pd
...
PATH = '/home/ec2-user/environment/udemy_courses/financial_analysis_py/12_quantopian/figs/'
...
plt.savefig(PATH + 'zscore.png', dpi=300)
plt.close()

# ### Rolling Z-Score
# 
# Our spread is currently American-United. Let's decide how to calculate
# this on a rolling basis for our use in Quantopian
...
plt.savefig(PATH + 'rolling_z.png', dpi=300)
plt.close()
sys.exit()
