...
PATH = '/home/ec2-user/environment/udemy_courses/data_science_py/10_pd_data_viz/figs/'
...
# ## Style Sheets
# 
# Matplotlib has [style sheets](http://matplotlib.org/gallery.html#style_sheets) 
# you can use to make your plots look a little nicer. These style sheets include
# plot_bmh,plot_fivethirtyeight,plot_ggplot and more. They basically create a
# set of style rules that your plots follow. I recommend using them, they make all 
# your plots have the same look and feel more professional. You can even create 
# your own if you want your company's plots to all have the same look (it is a 
# bit tedious to create on though).
# 
# Here is how to use them.
# 
# **Before plt.style.use() your plots look like this:**
df1['A'].hist()
plt.savefig(PATH + 'hist1.png', dpi=300)
plt.close()
...
# Let's stick with the ggplot style and actually show you how to utilize pandas 
...
plt.savefig(PATH + 'bar2.png', dpi=300)
plt.close()

# ## Histograms
df1['A'].plot.hist(bins=50)
plt.savefig(PATH + 'hist6.png', dpi=300)
plt.close()

# ## Line Plots
df1.reset_index().plot.line(x='index',y='B',figsize=(12,3),lw=1)
...
# Or use s to indicate size based off another column. s parameter needs to be 
# an array, not just the name of a column:
...
plt.savefig(PATH + 'hexbin.png', dpi=300)
plt.close()
...
# 
# Next we will learn about seaborn, which is a statistical visualization library 
# designed to work with pandas dataframes well.
# 
