...
# 
# Welcome to the KNN Project! This will be a simple project very similar to the 
# lecture, except you'll be given another data set. Go ahead and just follow the directions below.
# ## Import Libraries
...
plt.savefig(PATH + 'knn_pair.png', dpi=300)
plt.close()
...
# then keep track of the error_rate for each of these models with a list. Refer 
# to the lecture if you are confused on this step.**
error_rate = []
...
plt.savefig(PATH + 'k_val_err.png', dpi=300)
plt.close()
